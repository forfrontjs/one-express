        ...
        <nav className={`${styles.nav}`}>
          <ul className={styles.navList}>
            <li className={styles.navItem}>
              <HashLink smooth to="/#" className={styles.link}>
                Главная
              </HashLink>
            </li>
            <li className={styles.navItem}>
              <HashLink smooth to="/#Calculator" className={styles.link}>
                Калькулятор
              </HashLink>
            </li>
            <li className={styles.navItem}>
              <HashLink smooth to="/#tracking" className={styles.link}>
                Отслеживание
              </HashLink>
            </li>
            <li className={styles.navItem}>
        ...
        {menuOpen && (
          <div className={styles.navMenu}>
            <ul className={styles.burgerNavList}>
              <li className={styles.navItem}>
                <HashLink smooth to="/#" className={styles.link} onClick={toggleMenu}>
                  Главная
                </HashLink>
              </li>
              <li className={styles.navItem}>
                <HashLink smooth to="/#Calculator" className={styles.link} onClick={toggleMenu}>
                  Калькулятор
                </HashLink>
              </li>
              <li className={styles.navItem}>
                <HashLink smooth to="/#tracking" className={styles.link} onClick={toggleMenu}>
                  Отслеживание
                </HashLink>
              </li>
              <li className={styles.navItem}>
                <HashLink smooth to="/#Contact" className={styles.link} onClick={toggleMenu}>
                  Контакты
                </HashLink>
              </li>
              ...
              {!loggedIn && (
                <>
                  ...
                  <li className={styles.navItem}>
                    <Link to="/" className={styles.link} onClick={returnNav}>
                      Личный профиль
                    </Link>
                  </li>
                </>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H24V24H0V0ZM9.45 5.775H14.55C15.225 5.85 15.675 5.925 16.05 6.075C16.5 6.3 16.8 6.45 17.175 6.825C17.55 7.2 17.775 7.575 17.925 7.95C18.075 8.325 18.225 8.775 18.225 9.45V14.55C18.15 15.225 18.075 15.675 17.925 16.05C17.7 16.5 17.55 16.8 17.175 17.175C16.8 17.55 16.425 17.775 16.05 17.925C15.675 18.075 15.225 18.225 14.55 18.225H9.45C8.775 18.15 8.325 18.075 7.95 17.925C7.5 17.7 7.2 17.55 6.825 17.175C6.45 16.8 6.225 16.425 6.075 16.05C5.925 15.675 5.775 15.225 5.775 14.55V9.45C5.85 8.775 5.925 8.325 6.075 7.95C6.3 7.5 6.45 7.2 6.825 6.825C7.2 6.45 7.575 6.225 7.95 6.075C8.325 5.925 8.775 5.775 9.45 5.775Z" fill="#686A67" />
        ...
        <div className={styles.login}>
          {!loggedIn ? (
            ...
            <Link className={styles.loginButton} to="/login" onClick={handleLogout}>
              Выйти
            </Link>
          )}
        </div>
